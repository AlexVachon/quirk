...
exports.QuirkSignatureHelpProvider = void 0;
const vscode = require("vscode");
class QuirkSignatureHelpProvider {
    provideSignatureHelp(document, position, token, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const definitions = yield vscode.commands.executeCommand('vscode.executeDefinitionProvider', document.uri, funcPosition);
                if (definitions && definitions.length > 0) {
                    ...
                    while (lineNum >= 0) {
                        ...
                        if (!readingDocBlock) {
                            ...
                            if (lineText === '---')
                                ...
                                docstringLines.unshift(lineText);
                        }
                        lineNum--;
                    }
                    ...
                    if (parameters.length === 0 && sigParams.length > 0) {
                        for (const p of sigParams) {
                            if (p)
                                parameters.push(new vscode.ParameterInformation(p));
                        }
                    }
...
exports.QuirkSignatureHelpProvider = QuirkSignatureHelpProvider;
